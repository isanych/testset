...
struct select_support_trait<00,2> {
    ...
    static size_type ith_arg_pos_in_the_first_word(uint64_t w, uint32_t i, uint8_t offset, uint64_t carry)
    {
    ...
    static size_type ith_arg_pos_in_the_word(uint64_t w, uint32_t i, uint64_t carry)
    {
